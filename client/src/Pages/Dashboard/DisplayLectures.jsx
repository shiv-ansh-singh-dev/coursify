            ...
            <li className="font-semibold text-xl text-yellow-500 flex items-center justify-between">
              ...
              {role === "ADMIN" && (
                <button
                  ...
                  className="bg-yellow-600 text-white hover:bg-blue-500  px-2 py-1 rounded-md font-semibold text-sm"
                >
                  Add New Lecture
                </button>
              )}
                  ...
                  <li className="space-y-2" key={element._id}>
                    ...
                    {role === "ADMIN" && (
                      <button
                        ...
                        className="bg-red-500 hover:bg-red-700 px-2 py-1 rounded-md font-semibold text-sm"
                      >
                        Delete Lecture
                      </button>
                    )}
